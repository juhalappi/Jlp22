...
Rasinmäki told that they are still using J. I do not know waht is the situation today.
...
\item[\textbf{J}] JR\_0.0.tar.gz \hspace{1cm} File neede to us fortran subroutines in R
...
\end{itemize}
\item[\textbf{J}] Jdoc\_demo \hspace{1cm}documents and include file for running examples fro User's guide
\begin{itemize}
...
\textcolor{green}{!\,\item[\textbf{J}]\,makefile\_release\hspace{1cm}\,makefile\,for\,making\,release-\,version}
\end{itemize}
...
fi=\textcolor{VioletRed}{draw}(\textcolor{blue}{func->}\textcolor{VioletRed}{cos}(x),\textcolor{blue}{xrange->}(0,2*Pi),\textcolor{blue}{color->}Red,\textcolor{blue}{append->},\textcolor{blue}{continue->}fcont)\\
