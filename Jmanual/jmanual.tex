...
Version 30.12.2022 \textcolor{VioletRed}{jlp}() has now showdomain-> option which defines additional domains for which the sums 
...
\hrule 
\vspace{0.3cm} 
\noindent showdomain \tabto{3cm} -1-99 \tabto{5cm}  \textcolor{teal}{CHAR} \tabto{7cm} 
\begin{changemargin}{3cm}{0cm} 
...
\textcolor{teal}{jlpa}=\textcolor{VioletRed}{jlp}(\textcolor{blue}{problem->}\textcolor{teal}{proba},\textcolor{blue}{data->}cdata,showdomain->('site.le.3','site.gt.3'))\\ 
...
\textcolor{teal}{jlpb}=\textcolor{VioletRed}{jlp}(\textcolor{blue}{problem->}\textcolor{teal}{probb},\textcolor{blue}{data->}cdata,showdomain->'3.lt.site')\\ 
...
npv\#0==max\\ 
/         \\ 
jlpc=\textcolor{VioletRed}{jlp}(\textcolor{blue}{problem->}probc,\textcolor{blue}{data->}cdata,showdomain->'3.lt.site')\\ 
\end{example} 
\vspace{-7mm} \rule{5cm}{0.1pt} 
\onehalfspacing 
