...
I was not informed of the decision. Later Luke turned down any cooperation 
...
alive which was unfortunate for my mind and also because 
...
preparation of the formal opening decision and to take care of the publication. Second. 
The software contained so much dirty code that it could not be developed without my involvement, 
and barely even maintained. This 
suggests that an expert organization should listen the best experts before 
turning down the cooperation with them. 
...
\textcolor{teal}{jlpa}=\textcolor{VioletRed}{jlp}(\textcolor{blue}{problem->}\textcolor{teal}{proba},\textcolor{blue}{data->}cdata,\textcolor{blue}{showdomain->}('site.le.3','site.gt.3'))\\ 
...
\textcolor{teal}{jlpb}=\textcolor{VioletRed}{jlp}(\textcolor{blue}{problem->}\textcolor{teal}{probb},\textcolor{blue}{data->}cdata,\textcolor{blue}{showdomain->}'3.lt.site')\\ 
...
npv\#0==max\\ 
/         \\ 
jlpc=\textcolor{VioletRed}{jlp}(\textcolor{blue}{problem->}probc,\textcolor{blue}{data->}cdata,\textcolor{blue}{showdomain->}'3.lt.site')\\ 
\end{example} 
\vspace{-7mm} \rule{5cm}{0.1pt} 
\onehalfspacing 
\subsection{Factory opimization} 
\label{factopt} 
In factory optimization problems logs are transported to factories. The utility of tansported logs is defined 
introduced into the problem using terms which are TABLE objects. A TABLE consists of two \textcolor{teal}{LIST} objects. 
The first \textcolor{teal}{LIST} in factory optimization gives log types transported to to factories which are stored in the second \textcolor{teal}{LIST}. 
The properties of the factories in one factory list are defined with \textcolor{VioletRed}{datawcase}() function, which produces a standard \textcolor{teal}{DATA} 
object with an additional link to the 
\textcolor{teal}{LIST} of cases, which must the same as or equal to the first argument of \textcolor{VioletRed}{table}() function. 
Associated with 
with each TABLE term in a problem there is a \textcolor{teal}{MATRIX} with name table\%coef 
(table is the name of the table) having as many rows as there are 
elements in the log type 
\textcolor{teal}{LIST} in the TABLE term and as many columns as there are in the factory \textcolor{teal}{LIST} of the TABLE. 
...
unit variables and the factory variables defined with the \textcolor{VioletRed}{datawcase}() function. 
...
\hrule 
\vspace{0.3cm} 
\noindent \textcolor{blue}{knn} \tabto{3cm} 1 \tabto{5cm}  \textcolor{teal}{REAL}  \tabto{7cm} 
\begin{changemargin}{3cm}{0cm} 
\noindent  When considering to which factory a log type is transported, only knn 
factories according to values in table\%coef are considered. 
\end{changemargin} 
\vspace{0.3cm} 
\hrule 
\vspace{0.3cm} 
\noindent utiltran \tabto{3cm} 1 \tabto{5cm}  \textcolor{teal}{TRANS} \tabto{7cm} 
\begin{changemargin}{3cm}{0cm} 
\noindent  Transformation telling how table\%coef are computed for each unit. 
\end {changemargin} 
\hrule 
\vspace{0.2cm} 
\begin{note} 
If a given factory has no capacity for a given log type, no capacity constrain is needed. 
The zero capacity is indicated by giving a negative utility in \%coef matrix for a log type for which 
there is no capacity. 
\end{note} 
\singlespacing 
\begin{example}[factopt]Factory optimization (in preparation)\\ 
\label{factopt} 
\noindent {\color{ForestGreen}**	The following example shows how the factory optimization will work.}\\ 
 
{\color{ForestGreen}** There are 10 stands}\\ 
{\color{ForestGreen}** coordinates of stands in 100 x 100 area}\\ 
loc=\textcolor{VioletRed}{matrix}(10,2);\\ 
loc=\textcolor{VioletRed}{ran}();\\ 
loc=100*loc;\\ 
{\color{ForestGreen}** numbers of schedules in each stand}\\ 
ns=\textcolor{VioletRed}{matrix}(10,\textcolor{blue}{in->})\\ 
3                                                          \\ 
4                                                          \\ 
3                                                          \\ 
4                                                          \\ 
...
{\color{ForestGreen}** x and y are coordinates of of stands}\\ 
cdata=\textcolor{VioletRed}{newdata}(ns,loc,\textcolor{blue}{read->}(cdata\%nobsw,\textcolor{teal}{x},\textcolor{teal}{y}))\\ 
\textcolor{VioletRed}{stat}(\textcolor{blue}{sum->})\\ 
 
{\color{ForestGreen}** NS is total number of schedules generated randomly fro 5 periods}\\ 
NS=cdata\%nobsw\%sum;\\ 
xmat0=\textcolor{VioletRed}{matrix}(NS)\\ 
xmat0=\textcolor{VioletRed}{ran}()\\ 
xmat0=10*xmat0\\ 
 
tr=\textcolor{VioletRed}{trans}()\\ 
\textcolor{Red}{;do}(i,2,5)\\ 
\textcolor{teal}{x}"i"=\textcolor{teal}{x}"i-1"+\textcolor{VioletRed}{ran}()\\ 
\textcolor{Red}{;enddo}\\ 
\textcolor{Red}{;do}(i,1,5)\\ 
sawlog"i"=0.2*\textcolor{teal}{x}"i"\\ 
pulplog"i"=0.3*sawlog"i"\\ 
\textcolor{Red}{;enddo}\\ 
/                      \\ 
 
xdata=\textcolor{VioletRed}{newdata}(xmat0,\textcolor{blue}{read->}\textcolor{teal}{x1},\textcolor{blue}{maketrans->}tr)\\ 
\textcolor{VioletRed}{stat}()\\ 
\textcolor{VioletRed}{linkdata}(\textcolor{blue}{data->}cdata,\textcolor{blue}{subdata->}xdata)\\ 
 
{\color{ForestGreen}** sawmill properties, X and Y are coordinates of sawmills}\\ 
sawdata=\textcolor{VioletRed}{datawcase}(\textcolor{blue}{read->}(X,Y,capacity1...capacity5,util1...util5))\\ 
S1,20,30,5,6,7,8,6,10,10,11,10,10,12\\ 
S2,70,60,6,6,7,8,6,10,12,13,13,11,15\\ 
S3,10,70,5,6,7,8,6,10,13,14,14,11,13\\ 
/                                   \\ 
 
{\color{ForestGreen}**pulpmill properties}\\ 
pulpdata=\textcolor{VioletRed}{datawcase}(\textcolor{blue}{read->}(X,Y,capacity1...capacity5,util1...util5))\\ 
P1,40,30,2,3,2,4,3,4,3,3,4,4,4\\ 
P2,80,70,2,3,2,4,3,6,4,4,5,5,5\\ 
P3,20,90,2,3,2,4,3,6,5,5,6,6,4\\ 
/                             \\ 
 
{\color{ForestGreen}** sawlogs for different periods}\\ 
sawlogs=\textcolor{VioletRed}{list}(sawlog1...sawlog5);\\ 
pulplogs=\textcolor{VioletRed}{list}(pulplog1...pulplog5);\\ 
 
{\color{ForestGreen}** utility obtained from sawmills}\\ 
sutil=\textcolor{VioletRed}{table}(sawdata\%case,sawlogs);\\ 
 
{\color{ForestGreen}** matrix to which utilities are computed}\\ 
sutil\%coef=\textcolor{VioletRed}{matrix}(\textcolor{VioletRed}{len}(sawdata\%case),\textcolor{VioletRed}{len}(sawlogs))\\ 
 
{\color{ForestGreen}** utility from pulpmills}\\ 
putil=\textcolor{VioletRed}{table}(pulpdata\%case,pulplogs);\\ 
 
{\color{ForestGreen}** matrix to which utilities are computed}\\ 
putil\%coef=\textcolor{VioletRed}{matrix}(\textcolor{VioletRed}{len}(pulpdata\%case),\textcolor{VioletRed}{len}(pulplogs))\\ 
 
scost=0.1\,\,{\color{ForestGreen}! cost of transporting sawlogs, these could be period dependent}\\ 
pcost=0.2\,\,{\color{ForestGreen}! cost of transporting pulp logs}\\ 
 
util=\textcolor{VioletRed}{trans}()\\ 
\textcolor{Red}{;do}(i,1,\textcolor{VioletRed}{len}(sawdata\%case))\\ 
\textcolor{Red}{;do}(j,1,\textcolor{VioletRed}{len}(sawlogs))\\ 
 
{\color{ForestGreen}*sawdata("i",util"j") is value of variable util"j" for observation i in saw mill data}\\ 
sutil\%\textcolor{VioletRed}{coef}("i","j")=sawdata("i",util"j")-\\ 
scost*\textcolor{VioletRed}{sqrt}((sawdata("i",X)-\textcolor{teal}{x})***2+(sawdata("i",Y)-\textcolor{teal}{y})***2)\\ 
 
\textcolor{Red}{;enddo}\\ 
\textcolor{Red}{;enddo}\\ 
 
\textcolor{Red}{;do}(i,1,\textcolor{VioletRed}{len}(pulpdata\%case))\\ 
\textcolor{Red}{;do}(j,1,\textcolor{VioletRed}{len}(pulplogs))\\ 
 
putil\%\textcolor{VioletRed}{coef}("i","j")=pulpdata("i",util"j")-\\ 
pcost*\textcolor{VioletRed}{sqrt}((pulpdata("i",X)-\textcolor{teal}{x})***2+(pulpdata("i",Y)-\textcolor{teal}{y})***2)\\ 
 
\textcolor{Red}{;enddo}\\ 
\textcolor{Red}{;enddo}\\ 
/                      \\ 
 
fprob=\textcolor{VioletRed}{problem}()\\ 
{\color{ForestGreen}** utility from sawmills + utility from pulpmills}\\ 
sutil+putil==max\\ 
 
\textcolor{Red}{;do}(j,1,\textcolor{VioletRed}{len}(sawlogs))\\ 
\textcolor{Red}{;do}(i,1,\textcolor{VioletRed}{len}(sawdata\%case))\\ 
 
{\color{ForestGreen}* capacity constraints}\\ 
...
li=;list(fprob\%?);\\ 
@li;\\ 
f=\textcolor{VioletRed}{jlp}(\textcolor{blue}{problem->}fprob,\textcolor{blue}{data->}cdata,\textcolor{blue}{utiltrans->}util,\textcolor{blue}{knn->}2)\\ 
\textcolor{Red}{;return}\\ 
