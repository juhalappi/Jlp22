...
from varaible names or computation rules. Sparse data can be obtained using \textcolor{blue}{sparse->} 
option. \textcolor{teal}{Data} with named cases is now obtianed using case->option in \textcolor{VioletRed}{data}(), 
