...
Version   . New input programming function \textcolor{Red}{;now}() added. This is useful 
within \textcolor{VioletRed}{trans}() or within \textcolor{VioletRed}{problem}() when \textcolor{Red}{;do}() is present. 
...
by putting during the pause \textcolor{teal}{printresult} into zero. 
...
{\color{ForestGreen}** to be updated later}\\ 
\end{example} 
\vspace{-7mm} \rule{5cm}{0.1pt} 
\onehalfspacing 
...
/                   \\ 
sawsub=\textcolor{Red}{;list}(sawmills\%?);\\ 
@sawsub;\\ 
\textcolor{VioletRed}{stat}()\\ 
\end{example} 
\vspace{-7mm} \rule{5cm}{0.1pt} 
...
fi22=\textcolor{VioletRed}{drawclass}(cl,\textcolor{blue}{sd->},\textcolor{blue}{mean->},\textcolor{blue}{continue->},\textcolor{blue}{color->}\textcolor{teal}{Red},\textcolor{blue}{show->}0)\\ 
...
fi22=\textcolor{VioletRed}{drawclass}(cl,\textcolor{blue}{se->},\textcolor{blue}{mean->},\textcolor{blue}{color->}\textcolor{teal}{Black},\textcolor{blue}{width->}2,\textcolor{blue}{append->},\\ 
...
Numeric values refer to \textcolor{teal}{gnuplot} mar types. 
