...
Version 10.8.2023 Function matrixborder() added. It puts header on top and/or left of \textcolor{teal}{MATRIX}. 
...
\item All : All rows 
\item ili : Rows sepfied with a \textcolor{teal}{ILIST} object ili defined earlier 
...
row=\textcolor{VioletRed}{matrix}(2,\textcolor{blue}{values->}(2.5,3.6))\\ 
col=\textcolor{VioletRed}{matrix}(3,\textcolor{blue}{values->}(1,3.5,2))\\ 
matr=\textcolor{VioletRed}{matrix}(4,5,\textcolor{blue}{do->});\\ 
c=matr({2,3},{1,3,2});\\ 
c=matr(row,col);\\ 
\end{example} 
\vspace{-7mm} \rule{5cm}{0.1pt} 
...
\subsubsection{list2sym() makes \textcolor{teal}{LIST} of symbolic constants from another \textcolor{teal}{LIST}.} 
\label{list2sym} 
...
\vspace{-7mm} \rule{5cm}{0.1pt} 
\onehalfspacing 
\subsubsection{namenum() and namenum\%() take numbers from object name} 
\label{namenum} 
...
ab=matrixborder(a,\textcolor{blue}{column->}\textcolor{teal}{b});\\ 
c=\textcolor{VioletRed}{matrix}(3,\textcolor{blue}{values->}(4,2,5));\\ 
ac=matrixborder(a,\textcolor{blue}{row->}c);\\ 
abc=matrixborder(a,\textcolor{blue}{row->}c,\textcolor{blue}{column->}\textcolor{teal}{b});\\ 
row=\textcolor{VioletRed}{list}(\textcolor{teal}{x1}...\textcolor{teal}{x3})\\ 
@row=4,2,5\\ 
col=\textcolor{VioletRed}{list}(c1,c2)\\ 
@col=2,5\\ 
ab=matrixborder(a,\textcolor{blue}{column->}col);\\ 
ac=matrixborder(a,\textcolor{blue}{row->}row);\\ 
abc=matrixborder(a,\textcolor{blue}{row->}row,\textcolor{blue}{column->}col);\\ 
ab=matrixborder(a,\textcolor{blue}{column->}(2,5));\\ 
ac=matrixborder(a,\textcolor{blue}{row->}(4,2,5));\\ 
abc=matrixborder(a,\textcolor{blue}{row->}(4,2,5),\textcolor{blue}{column->}(2,5));\\ 
\end{example} 
\vspace{-7mm} \rule{5cm}{0.1pt} 
\onehalfspacing 
...
code-> option to indicate that interpretation is needed for getting values. If there is \textcolor{blue}{sparse->} or case-> 
...
\hrule 
\vspace{0.3cm} 
\noindent maxobs  \tabto{3cm} N|0 \tabto{5cm}   \tabto{7cm} 
\begin{changemargin}{3cm}{0cm} 
