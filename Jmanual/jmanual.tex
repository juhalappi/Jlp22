...
It has been difficult for me to recover from the time when I waited so many years 
for the possibility to complete my life's work and saw that the days of my life were just running out without 
giving me that possibility, just because the leaders of Luke had so decided. This process has been 
a me-too experience for me, or perhaps a similar experience what 
a mother undergoes when social workers take her child and put him into a orphanage where the child is 
given only water and bread but no education or care. In the previous versions of the preface, I decribed the process with details which 
kept my bitterness alive. From this version I have dropped the names of the involved eleven leaders and all details of their doings 
and wrong doings. But I anyhow want to tell what was the essence of the process from my point of view. 
 
The process can be described as a hostile take over. I waited that the leaders would make the opening decision 
...
Luke rejected my co operation offer to include these codes in the publication it was preparing. Luke pretended 
...
agree with me or the leaders of Luke? A task of the Board of Directors is promote cooperation with stakeholders. 
I am now a stakeholder in this matter, and other stakeholders are also linked to this project through their 
cooperation with me. Can the board of Directors help to solve this dispute. 
Or are the leaders even so brave that they could admit that they did not recognize during 
the process that a researcher has the right to publish 
his results but they have changed their opinion? I got finally the permission to publish my results, 
but if the leaders of Luke do not accept this as right of a researcher, 
...
Luke was not rational with respect to the interests of Luke. 
...
Could the leaders of Luke be even so brave that they could admit that during their efforts to advance 
the interests of Luke they were actually making harm to these because they 
were not willing to listen the person who knew everyhing in this matter 
...
nodes after branchinh are stored. See keepopen-> and \textcolor{blue}{continue->} options in \textcolor{VioletRed}{data}(). Function \textcolor{VioletRed}{joindata}() is 
...
schedules into thesae new compponent datas. \textcolor{VioletRed}{splitdata}() can be used to convert data generated with previous simulators 
into this new format. It is recommeneded that a simulator generating data for \textbf{Jlp22} startys to write directly into this new format. 
 
Now the variable telling the number of observations in \textcolor{teal}{DATA} \textcolor{teal}{datab} is always \textcolor{teal}{datab}\%obs. Similarly the variable 
telling how many children that observation has in the lower level is now always \textcolor{teal}{datab}\%nobsw and it must be the 
telling how many children that observation has in the lower level is now always \textcolor{teal}{datab}\%nobsw and it must be the 
first varaible in the list of variables. This new legisaltion was necessary to keep the new multilevel 
datas in order. 
 
Version Dec 20 2022 gives possibility to chnage fonts in figures. 
...
in the batch mode, or if the initial   \textcolor{Red}{;incl} -file containscommand batch(), the \textbf{Jlp22} is operated in 
...
\begin{changemargin}{3cm}{0cm} 
\noindent  \textcolor{teal}{LIST} and separate non-list objects. 
\end {changemargin} 
\hrule 
\vspace{0.2cm} 
\singlespacing 
...
\label{mergex} 
\noindent \textcolor{teal}{x1}...\textcolor{teal}{x3}=1,2,3\\ 
mat=\textcolor{VioletRed}{matrix}(3,\textcolor{blue}{values->}(4,5,6))\\ 
lis0=\textcolor{VioletRed}{list}(\textcolor{teal}{x2},\textcolor{teal}{x1})\\ 
lis2=\textcolor{VioletRed}{merge}(\textcolor{teal}{x1},mat,lis0)\\ 
...
\vspace{-7mm} \rule{5cm}{0.1pt} 
\onehalfspacing 
\subsection{\textcolor{VioletRed}{index}() Index in a \textcolor{teal}{LIST}}\index{index()} 
\label{index} 
