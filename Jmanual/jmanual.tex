...
\label{fill} 
Currently \textcolor{VioletRed}{fill}() uses linear interpolation to fill rows or columns. 
\vspace{0.3cm} 
\hrule 
\vspace{0.3cm} 
...
\begin{changemargin}{3cm}{0cm} 
\noindent rows are filled using linear interpolation 
\end{changemargin} 
\vspace{0.3cm} 
\hrule 
\vspace{0.3cm} 
...
\begin{changemargin}{3cm}{0cm} 
\noindent columns are filled using linear interpolation 
\end {changemargin} 
\hrule 
\vspace{0.2cm} 
\begin{note} 
...
\label{fillex} 
\noindent a=\textcolor{VioletRed}{matrix}(4,5,\textcolor{blue}{do->});\\ 
a(2,\{1,3\})=0\\ 
a;\\ 
\textcolor{teal}{b}=\textcolor{VioletRed}{fill}(a,\textcolor{blue}{row->});\\ 
\textcolor{teal}{b}=\textcolor{VioletRed}{fill}(a,\textcolor{blue}{column->});\\ 
\end{example} 
\vspace{-7mm} \rule{5cm}{0.1pt} 
\onehalfspacing 
...
\textcolor{teal}{x}-> option referring to a \textcolor{teal}{MATRIX}, those valuse give the \textcolor{teal}{x}-coordinates, otherwise 
...
\hrule 
\vspace{0.3cm} 
\noindent \textcolor{blue}{stop}  \tabto{3cm} 0|1  \tabto{5cm}  CODE  \tabto{7cm} 
\begin{changemargin}{3cm}{0cm} 
\noindent  Code option defining in terms of \$\textcolor{teal}{x}, \$xold,\$\textcolor{teal}{y} and \$yold when 
a break is generated. For first point \$xold=\$\textcolor{teal}{x} and \$yold=\$\textcolor{teal}{y} 
\end{changemargin} 
\vspace{0.3cm} 
\hrule 
\vspace{0.3cm} 
...
\begin{changemargin}{3cm}{0cm} 
\noindent  Code option defining in terms of \$\textcolor{teal}{x}, \$xold,\$\textcolor{teal}{y} and \$yold when 
a point is accepted. For first point \$xold=\$\textcolor{teal}{x} and \$yold=\$\textcolor{teal}{y}. 
\end{changemargin} 
\vspace{0.3cm} 
\hrule 
\vspace{0.3cm} 
...
fi=\textcolor{VioletRed}{drawline}(1,2,3,4,3,4,0,5,\textcolor{blue}{continue->}fcont)\\ 
fi=\textcolor{VioletRed}{drawline}(1,2,3,4,3,4,0,5,\textcolor{blue}{continue->}fcont,\textcolor{blue}{filter->}\$\textcolor{teal}{y}.gt.0)\\ 
fi=\textcolor{VioletRed}{drawline}(1,2,1,2,3,4,3.4,5,\textcolor{blue}{continue->}fcont,\textcolor{blue}{stop->}\$\textcolor{teal}{x}.lt.\$xold)\\ 
\textcolor{Red}{;if}(wait)\textcolor{Red}{;pause}\\ 
\textcolor{Red}{;return}\\ 
	!                      \\ 
\end{example} 
...
\subsection{\textcolor{VioletRed}{stemcurve}() stem curve used with linear interpolation}\index{stemcurve()} 
\label{stemcurve} 
