...
\hrule 
\vspace{0.3cm} 
\noindent merge \tabto{3cm} N \tabto{5cm}    \tabto{7cm} 
\begin{changemargin}{3cm}{0cm} 
...
li=\textcolor{VioletRed}{list}(\textcolor{teal}{x1}...x5,merge->);\\ 
li=\textcolor{VioletRed}{list}(\textcolor{teal}{x1}...x5,\textcolor{teal}{x2}...x4,merge->);\\ 
