...
\textcolor{teal}{jlpza}=\textcolor{VioletRed}{jlpz}(\textcolor{blue}{zmatrix->}\textcolor{teal}{jlpcoefa}\%matrix,\textcolor{blue}{rhs->}\textcolor{teal}{jlpcoefa}\%rhs,\textcolor{blue}{rhs2->}\textcolor{teal}{jlpcoefa}\%rhs2,\textcolor{blue}{min->}\textcolor{teal}{jlpcoefa}\%obj)\\ 
\end{example} 
\vspace{-7mm} \rule{5cm}{0.1pt} 
\onehalfspacing 
...
\textcolor{blue}{se->} error bars. Using \textcolor{blue}{width->}(1,2) gives nice looking error bars. 
...
fi=\textcolor{VioletRed}{drawclass}(cl,\textcolor{blue}{sd->},\textcolor{blue}{se->},\textcolor{blue}{continue->}fcont,\textcolor{blue}{color->}\textcolor{teal}{Red},\textcolor{blue}{width->}(2,1))\\ 
...
codeoption \textcolor{blue}{obj->}. 
The function can write all possible schedules into the disk if there is option \textcolor{blue}{write->}. 
If option \textcolor{blue}{any->} is not present, a bucking scedule is not accepted, if it would be possible 
to make one more log with length Lmin and top diamter Dmin. 
The function requires a codeoption \textcolor{blue}{func->} which determines in terms of the top 
...
In a recent study I have used \textcolor{blue}{func->}(1-bf*gam**Dtop), where gam=0.97487124 and 
bf=0.63217650. 
A call of function looks like:\\ 
u=\textcolor{VioletRed}{stemopt}(Lmin,Lmax,Dmin,dmin,dee,iobs,\textcolor{blue}{func->}(1-bf*gam**Dtop),\textcolor{blue}{obj->}U\%saw)\\ 
