...
\begin{changemargin}{3cm}{0cm} 
\noindent the range for \textcolor{teal}{x}-axes. Gnuplot generates it automatically, but 
...
\begin{changemargin}{3cm}{0cm} 
\noindent  the range for \textcolor{teal}{y}-axes. Gnuplot generates it automatically, but 
sometimes the range used by Gnuplot needs to be changed. 
\end{changemargin} 
\vspace{0.3cm} 
\hrule 
...
fi=\textcolor{VioletRed}{draw}(\textcolor{blue}{func->}\textcolor{VioletRed}{sin}(u),\textcolor{blue}{xfunc->}\textcolor{VioletRed}{cos}(u),\textcolor{teal}{x}->u,\textcolor{blue}{xrange->}(0,0.5*\textcolor{teal}{Pi}))\\ 
...
Gnuplot commands and file \textcolor{teal}{fi}.jfi0 containg data. If scandic characters are needed 
