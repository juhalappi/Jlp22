...
I was not informed of the decision. I heard that such decision has been made but 
...
research if the leaders think that the results are so important that they want to publish them? 
...
Version 31.1.2022. \textcolor{VioletRed}{jlp}() solves (again) problems without any constraints. 
...
\textcolor{blue}{nrowtot->} gives the total number of observations when joindata is used several times to put several DATAs into 
the same \textcolor{teal}{DATA}.\\ 
\textcolor{blue}{append->} current data are appended to a \textcolor{teal}{DATA} for which space has been reserved with \textcolor{blue}{nrowtot->} 
\begin{note} 
...
Xdatanew=\textcolor{VioletRed}{joindata}(cdata,xdataP\#1...xdataP\#5,\textcolor{blue}{nrowtot->}nobstot)\\ 
