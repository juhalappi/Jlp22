...
\textbf{J} data structures and it makes indentations, writes comments to endif and enddo
...
Arguments:
arg1,…,argn
arguments can be any \textbf{J} objects or values of arithmetic or logical expressions or
...
\hline
\vspace{0.3cm}
\noindent time \tabto{3cm} -1|0 \tabto{5cm}   \tabto{7cm}
\begin{changemargin}{3cm}{0cm}
\noindent  If time-> is present, the cpu-time and total time in function are printed
...
\end{example}
\subsection{datawcase(): Creates a data object where eac observation has name}
\label{datawcase}
...
\begin{changemargin}{3cm}{0cm}
\noindent 	data objects , see section Common options for default\textcolor{green}{!\,weight\,	gives\,the\,weight\,of\,each\,observations\,if\,weighted\,means\,and\,variances\,ar}
...
\hline
\vspace{0.3cm}
\noindent tailtofirst \tabto{3cm} -1|0 \tabto{5cm}   \tabto{7cm}
\begin{changemargin}{3cm}{0cm}
...
\hline
\vspace{0.3cm}
\noindent tailtolast \tabto{3cm} -1|0 \tabto{5cm}   \tabto{7cm}
\begin{changemargin}{3cm}{0cm}
...
\hline
\vspace{0.3cm}
\noindent cumulative  \tabto{3cm} N|0  \tabto{5cm}    \tabto{7cm}
\begin{changemargin}{3cm}{0cm}
...
agreement with Luke
I will here describe the history of \textbf{J} here in unusual
